...
cfg.txrx = [24 1]; % Row/Column of antenna array; Default: [8 8]
...
cfg.fileLoc = '~/Users/tjy511/Google Drive/Academic/papers/paper3/figs/simulation/experiments/experiment3/';
